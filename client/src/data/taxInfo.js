  ...
  contentRows: {
    cells: [
      ...
      },
      {
        ...
        text: "<strong>YES</strong>. Do not get confused by other au pairs saying you do not have to pay taxes. The U.S. Department of Labor decided in 1994 that an employer-employee relationship exists between host families and au pairs which classifies the au pair stipend as &quot;wages&quot;. Therefore, <strong>au pairs owe tax on all of the money they earned within the country</strong>. Be aware that if you choose not to file your tax return, you may ruin your chances of receiving another US visa or Green Card in the future.",
      },
      {
        title: "How Much Will I Have to Pay?",
        text: "The exact amount veries every year, but you can expect to pay around 10% of your taxable income for federal taxes. State taxes are much lower and only some states even require you to pay state taxes.",
      },
      {
        title: "Which Form(s) Do I Need to Fill Out?",
        text: "You will most likely have to file Form 1040NR-EZ, a federal income tax form for non-residents. There are a few exceptions though! If you were on a different visa before obtaining your J-1, we recommend asking a professional to verify which form you will have to fill out.",
      },
      {
